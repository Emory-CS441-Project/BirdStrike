<script lang="ts">
	...
	const TOP_AIRPORTS: Airport[] = [
		...
		{ name: 'Seattle-Tacoma',      code: 'SEA', lat: 47.450,  lon: -122.309 },
...
<figure class="space-y-3">
	...
	<p class="text-sm text-gray-500">
		Each bubble covers a ~{GRID_DEG}° grid cell. <strong>Size and colour</strong> both encode
		strike density: larger and darker orange means more strikes in that area.
